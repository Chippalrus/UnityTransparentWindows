...
public class TransparentWindow : MonoBehaviour
{
	...
	[SerializeField] int targetFrameRate = 500;

	[Tooltip("Always On Top")] //
	[SerializeField] private bool m_bAlwaysOnTop = false;

	[Tooltip("Enable/Disable Click through")] //
	[SerializeField] private bool m_bClickThrough = false;

	public bool GetAlwaysOnTop(){ return m_bAlwaysOnTop; }
	public bool GetClickThrough(){ return m_bClickThrough; }
	public void SetAlwaysOnTop( bool bVal ){ m_bAlwaysOnTop = bVal; }
	public void SetClickThrough( bool bVal ){ m_bClickThrough = bVal; }
	...
	void Awake()
	{
		...
		//Camera.GetComponent< UnityEngine.Rendering.Universal.UniversalAdditionalCameraData >().renderPostProcessing = false;
		...
		SetWindowLong(hwnd, GWL_STYLE, WS_POPUP | WS_VISIBLE);
		SetWindowPos(hwnd, HWND_NOTOPMOST, windowRect.Left, windowRect.Top, fWidth, fHeight, 32 | 64);
		DwmExtendFrameIntoClientArea(hwnd, ref margins);
#endif
        }
	}
	...
	void Update()
	{
		...
		if( m_bClickThrough ){ SetClickThrough(); }
	}
